...
public class StarHospitalCashServiceImpl implements StarHospitalCashService {
	...
	public Object findPremium(RequestData data) {
		...
		for (int year = 1; year <= 3; year++) {
			...
			int premium = 0;
			premiumEntity = premiumRepository.findStarHospitalCashInsurancePremium(productCode, age, adultCount,
					childCount, policyPlan, year, policyDays);
