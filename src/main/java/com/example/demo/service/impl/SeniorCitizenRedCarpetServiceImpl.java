...
public class SeniorCitizenRedCarpetServiceImpl implements SeniorCitizenRedCarpetService{
	...
	@Override
	public Object findSeniorCitizenRedCarpetPremium(RequestData data) {
		...
		for (int year = 1; year <= 3; year++) {
			...
			int premium=0;
			premiumEntity=premiumRepository.findSeniorCitizenRedCarpetPremium(adultCount, year, paymentPlan, productCode, policyType);
