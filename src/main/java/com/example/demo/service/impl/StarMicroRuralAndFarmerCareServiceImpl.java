...
@Service("Star Micro Rural and Farmers Care")
public class StarMicroRuralAndFarmerCareServiceImpl implements StarMicroRuralAndFarmerCareService {
	...
	public Object findPremium(RequestData data) {
		...
		int premium = 0;
		premiumEntity = premiumRepository.findStarMicroRuralAndFarmerCarePremium(age, adultCount, childCount,
				paymentPlan, productCode);
